...
- [x] 1.3 Add `app/web-app/AGENTS.md` with frontend-specific architecture and implementation guidance
- [x] 1.4 Add `app/web-app/docs/design-system.md` for brand, tokens, layout, and motion guidance

## 2. Web App Architecture Plan

- [x] 2.1 Define the target folder breakdown for shell, playback, transcript, stage, and shared UI concerns in `app/web-app`
...
- [x] 4.1 Create the initial `app/agent-service` workspace scaffold when runtime work begins
- [x] 4.2 Define the first service contract between `app/agent-service` outputs and web-app inputs
